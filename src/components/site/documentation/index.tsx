  ...
  const docs = [
    ...
    },
    {
      ...
      content: (
        <>
          <p className='mb-4'>
            The <strong className='font-bold'>Agency Dashboard</strong> serves
            as your command center, providing a comprehensive overview of your
          ...
          <ul className='list-disc pl-5 mb-4'>
            ...
            <li className='mb-2'>
              <strong>Team</strong> management for adding or managing agency
              team members.
            </li>
            <li className='mb-2'>
      ...
      content: (
        <>
          ...
          <p className='mb-4'>
            ...
            seamless onboarding experience, perfectly setting up your
            sub-account for success.
          </p>
        </>
      ),
      ...
      content: (
        <>
          ...
          <p className='mb-4'>
            ...
            built-in reporting tools to track progress, identify bottlenecks,
            and analyze the performance of your projects.
          </p>
        </>
      ),
